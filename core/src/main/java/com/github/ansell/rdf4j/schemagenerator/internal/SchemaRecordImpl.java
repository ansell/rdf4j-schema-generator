...
public class SchemaRecordImpl implements SchemaRecord {
    ...
    public SchemaRecordImpl(IRI nextIRI, String formattedRecordKey, String rawRecordKey,
            Literal nextLabel, Literal nextDescription) {
        this.iri = Objects.requireNonNull(nextIRI, "IRI cannot be null");
        this.formattedRecordKey = Objects.requireNonNull(formattedRecordKey,
                "Formatted record key cannot be null for IRI: " + nextIRI);
        this.rawRecordKey = Objects.requireNonNull(rawRecordKey,
                "Raw record key cannot be null for IRI: " + nextIRI);
